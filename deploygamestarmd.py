...
# Zenserp API Credentials (Using Environment Variables)
ZENSERP_API_KEY = os.getenv("8d38a4d0-f099-11ef-a5fc-b1de60a7a21d")
ZENSERP_ENDPOINT = os.getenv("https://app.zenserp.com/api/v2/search")
...
# Deployment-ready start command
